...
@fallback: 'Meta SC Offc Pro Normal';
@sans: 'Meta SC Offc Pro Book', @fallback;
@sans_md: 'Meta SC Offc Pro Medium', @fallback;
@sans_bd: 'Meta SC Offc Pro Bold', @fallback;
@sans_it: 'Meta SC Offc Pro Book Italic', @fallback;
