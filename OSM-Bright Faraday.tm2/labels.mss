...
@fallback: 'Elementa Pro Regular';
@sans: 'Elementa Pro Regular', @fallback;
@sans_md: 'Elementa Rough Pro Regular', @fallback;
@sans_bd: 'Elementa Pro Bold', @fallback;
@sans_it: 'Elementa Pro Italic', @fallback;
